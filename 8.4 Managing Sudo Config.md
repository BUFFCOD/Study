...
/etc/sudoers.
  ...
  ⚠️ Important: Never edit /etc/sudoers directly. Always use the visudo
...
⚙️ Enabling Sudo Access for the Wheel Group
...
⏳ Adjusting Sudo Password Timeout
...
sudo. Example:
    ...
    lisaa ALL=(ALL) /sbin/useradd, /usr/bin/passwd

This allows lisaa to manage users and passwords, but not run other
...
Copy from Remote to Local
  ...
  🔑 Tip: Since scp uses SSH, you must have SSH access to the remote
  host for it to work.
